...
namespace AstronomicalProcessing
{
    partial class AstronomicalProcessingForm
    {
        ...
        // CR: 4	There is an input field (text box) so data can be deleted, added and edited.
        // CR: 2	The client can use a text box input to search the array.
        // PR: 5	A single text box is provided for the search input.
        private System.Windows.Forms.TextBox TextBoxMain;

        //CR : 3	There are buttons that can sort and search the data.
